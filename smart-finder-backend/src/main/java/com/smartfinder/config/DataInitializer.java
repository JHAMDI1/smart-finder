...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Critere prises = saveCritere("Prises électriques", "Prises disponibles aux tables", "Connectivité", "plug");
        Critere calme = saveCritere("Ambiance calme", "Espace silencieux pour travailler", "Ambiance", "volume-off");
        ...
        Critere cafe = saveCritere("Café de qualité", "Café artisanal et boissons premium", "Restauration", "coffee");
        Critere coworking = saveCritere("Espace coworking", "Tables partagées et salles de réunion", "Espace", "users");
        ...
        log.info("5 lieux créés avec critères");

        // ── Avis ───────────────────────────────────────────
        createAvis(lieu1, user1, 5, "Excellent café ! WiFi rapide, ambiance au top. J'y travaille tous les jours.");
        ...
        createAvis(lieu3, user2, 4, "Super brunch ! Le WiFi est un peu instable mais l'endroit vaut le détour.");
    ...
    private Lieu createLieu(String nom, String adresse, String description,
            ...
            BigDecimal noteMoyenne, List<Critere> criteres) {
